...
parser.add_argument('--src_dir', default='/data/kepler/lol_v2/Train', type=str, help='Directory for full resolution images')    # For LOL-V2
parser.add_argument('--tar_dir', default='/data/kepler/lol_v2/Train_patch',type=str, help='Directory for image patches')
parser.add_argument('--type', default='LOL-V2', type=str, help='The DataSet Type')
