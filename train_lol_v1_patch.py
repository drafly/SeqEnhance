...
parser.add_argument('--img_path', type=str, default='/data/kepler/lol_v1/Train_patch/Low/')
...
parser.add_argument('--snapshots_folder', type=str, default="/output/snapshots_folder_lol_v1_patch")
